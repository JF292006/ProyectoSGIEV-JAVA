...
<div class="form-container">
    ...
    <form action="${pageContext.request.contextPath}/proveedor?action=insertar" method="post">
        ...
        <div class="btn-container">
            ...
            <button type="button" class="back-btn" onclick="window.location.href='${pageContext.request.contextPath}/crudproveedor.jsp'">Cancelar</button>
        </div>
    </form>
</div>
