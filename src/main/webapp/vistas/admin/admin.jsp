<%-- 
    Document   : admin
    Created on : 28/06/2025, 5:41:26 p. m.
...
<body>
    <header>
        ...
        <div class="user-info">
            <span class="admin-name">Admin Activo</span>
    ...
    <main class="admin-dashboard">
        <div class="dashboard-grid">
            ...
            <div class="dashboard-module usuarios">
                ...
                <p>Administra perfiles de proveedores</p>
                <a href="${pageContext.request.contextPath}/proveedor?action=listar" class="module-link">Ir a Proveedores</a>
            </div>
            ...
            <div class="dashboard-module inventario">
                <div class="module-icon">✉</div>
                <h2>Gestionar Mensajeria</h2>
                <p>Mantén un control preciso de tus mensajerias</p>
                <a href="${pageContext.request.contextPath}/mensajeriaController?accion=listar" class="module-link">Ir a mensajerias</a>
            </div>
        </div>
    </main>
