...
<header>
 ...
 <nav class="navbar">
  <button class="nav-btn" onclick="window.location.href='${pageContext.request.contextPath}/vistas/admin/admin.jsp'">Ir a Panel</button>
    <button class="nav-btn" onclick="window.location.href='${pageContext.request.contextPath}/vistas/admin/crudproveedor.jsp'">Ir a Proveedor</button>
...
<button class="add-btn" onclick="window.location.href='${pageContext.request.contextPath}/vistas/admin/formulario_venta.jsp'">+ Añadir Venta</button>
            </div>
